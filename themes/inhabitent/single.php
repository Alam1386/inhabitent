		...
		<?php while ( have_posts() ) : the_post(); ?>
			...
			<div class="entry-content">
              ...
              <div class="social-buttons">
                ...
                <button type="button" class="black-btn"><i class="fab fa-twitter-square"></i> Tweet</button>
                <button type="button" class="black-btn"><i class="fab fa-pinterest-square"></i> Pin</button>
              </div>
            </div><!-- .entry-content -->
			<?php
